...
data class MatchInfo(
    ...
    val state: String = "",
    val status: String = "",
    val team1: CricbuzzTeam? = null,
    val team2: CricbuzzTeam? = null,
...
data class MatchListResponse(
    val data: List<CricMatch>? = null,
    val status: String = ""
)

data class MatchInfoResponse(
    val data: MatchDetail? = null,
    val status: String = ""
)
...
interface CricApiService {
    ...
    suspend fun getMatches(
        @Query("apikey") apiKey: String = CRIC_API_KEY,
